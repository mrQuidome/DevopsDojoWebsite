      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: const TabBarView(
            children: [
              Card(child: Text('Description'), margin: EdgeInsets.all(50)),
              Card(child: Text('''What Is Java?
...
•	Describe a static method and demonstrate its use within a program
              ...
              Card(child: Text('None'), margin: EdgeInsets.all(50)),
              Card(child: Text('Price'), margin: EdgeInsets.all(50)),
              Card(child: Text('Certficate'), margin: EdgeInsets.all(50)),
              Card(child: Text('Buy'), margin: EdgeInsets.all(50)),
            ],
          ),
        ),
      ),
